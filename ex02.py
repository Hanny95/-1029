    ...
    for p in range(2, 28):
        ...
        for i in range(1, 21):
            ...
            try:
                ...
                bookPrice = browser.find_element(By.CSS_SELECTOR, f'#main_contents > ul > li:nth-child({i*6}) > div.detail > div.price > strong')


                print(f'title : {bookTitle.text}')
                authorList = (bookAuthor.text).split('|')
